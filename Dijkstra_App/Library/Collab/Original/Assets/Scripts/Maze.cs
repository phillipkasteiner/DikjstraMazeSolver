...
public class Maze : MonoBehaviour
{
    ...
    void CreateWallsFloors()
    {
        ...
        totalPaths = 0;
        var maze_gen = GameObject.Find("Maze_Gen"); 
        wallHolder = new GameObject(); // Create object for wallHolder
        wallHolder.name = "Maze_Walls"; // Rename to Maze in hierarchy
        wallHolder.transform.parent = maze_gen.transform;
        wallHolder.layer = LayerMask.NameToLayer("UI");

        floorHolder = new GameObject(); // Create object for floorHolder
        floorHolder.name = "Maze_Floors";
        floorHolder.transform.parent = maze_gen.transform;
        floorHolder.layer = LayerMask.NameToLayer("UI");
